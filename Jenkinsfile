pipeline {
    ...
    environment {
        GIT_REPOSITORY_URL = 'https://github.com/mrunal493/docker_jenkins_demo.git'
        DOCKER_IMAGE_NAME = 'mrunal493/docker_jenkins_demo'
        IMAGE_TAG = '1.0'
    }
                ...
                script {
                    try {
                        withCredentials([usernamePassword(credentialsId: 'my-docker-hub-credentials-id', 
                                                         usernameVariable: 'Mrunal493', 
                                                         passwordVariable: 'Mjagtap@2')]) {
